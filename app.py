...
class LLM_agent():
    ...
    default_prompt = """
        ...
        Step 5: Implement "If-Then" Plans Objective: Form specific implementation intentions. Phase 1: Create an If-Then Plan: Link a trigger with new, healthier behavior. Example: "If I feel stressed, then I will take a walk." Your Turn: (Write your If-Then plan here) Conclusion: Great job! You’ve set a solid foundation for changing your habit. Keep practicing these steps, and remember, every small effort counts towards your overall success. Continue your journey and celebrate your progress!
    """
