...
class LLM_agent():
    ...
    default_prompt = """
        ...
        # Objective: To systematically unpack a specific past moment of decision, enabling the user to gain clarity on why they acted (or didn't act) as they did, and to identify the short-term and long-term consequences of that choice. This understanding aims to foster insights for future behavior change.
